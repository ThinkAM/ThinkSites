...
{
    public abstract class ThinkSitesWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ThinkSitesWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ThinkSitesWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ThinkSitesDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ThinkSitesDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ThinkSitesDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ThinkSitesDbContext, Task<T>> func)
        {
            T result;
